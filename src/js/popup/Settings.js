...
class Settings {
  ...
  constructor() {
    ...
    this.themeSwitcherInputElements =
      this.themeSwitcherElement.querySelectorAll(
        this.selectors.themeSwitcherInput,
      );
    this.themeSwitchableElements = document.querySelectorAll(
      this.selectors.themeSwitchableElement,
    );
  ...
  async initState() {
    ...
    if (!safeTheme)
      safeTheme = [...this.themeSwitcherInputElements].find(
        (input) => input.checked,
      ).value;
